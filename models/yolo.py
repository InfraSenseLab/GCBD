...
def parse_model(d, ch):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in {
                ...
                BottleneckCSP, C3, C3TR, C3SPP, C3Ghost, nn.ConvTranspose2d, DWConvTranspose2d, C3x, ConvTranspose2d}:
            c1, c2 = ch[f], args[0]
            ...
            if m in {BottleneckCSP, C3, C3TR, C3Ghost, C3x}:
                ...
                n = 1
        elif m is {nn.BatchNorm2d, nn.MaxPool2d}:
            args = [ch[f]]
        elif m is Concat:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='patch_classify/yolov5-swin-base.yaml', help='model.yaml')
    ...
    # Create model
    im = torch.rand(opt.batch_size, 3, 702, 702).to(device).half()
